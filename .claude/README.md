...
| -------------------- | ----------- | --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **audit**            | 🟠 foundry  | `/audit [<scope>...] [--upgrade \| --adversarial] [--skip-gate]`                  | Config audit: broken refs, inventory drift, docs freshness; fix level chosen via always-fire follow-up gate; `--upgrade` applies docs-sourced improvements; `--adversarial` runs challenger + Codex review                                                                                                                |
